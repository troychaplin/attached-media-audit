...
class Batch_Runner {
	...
	const CRON_HOOK     = 'attached_media_audit_full_scan';
	const BATCH_SIZE    = 50;
	...
	const CURSOR_KEY    = 'attached_media_audit_cursor';
	const SUMMARY_CURSOR_KEY = 'attached_media_audit_summary_cursor';
	const PHASE_KEY     = 'attached_media_audit_phase';
	const PROGRESS_KEY  = 'attached_media_audit_progress';
	const INDEX_BUILT_KEY = 'attached_media_audit_index_built';
	const ATTACHMENT_IDS_KEY = 'attached_media_audit_attachment_ids';
